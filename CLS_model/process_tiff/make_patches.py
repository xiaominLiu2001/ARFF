...
def tiling(slide_filepath, magnification, patch_size, scale_factor=32, tissue_thresh=0.5,
    ...
    # Check if the image is already a 3-channel BGR image, if not, convert it
...
def run(args):
    ...
    # mask_part_dir = Path(args.mask_part_dir)
    coord_dir = save_dir / 'coord_pred'
    ...
    if args.overview:
        ...
        print("thumbnail_dir = None \n overview_dir = None")
        thumbnail_dir = None
        overview_dir = None
    if args.save_mask:
        # mask_dir = save_dir / 'mask' / args.mask_part_dir
...
def main():
    ...
    parser.add_argument('--slide_dir', type=str, default='/home/dataset/FTD_DATA/slide')
    parser.add_argument('--mask_dir', type=str, default='/home/ARFF/Dataset_FTD/annotations')
    parser.add_argument('--save_dir', type=str, default='/home/ARFF/CLS_model/data_FTD')
    parser.add_argument('--thumbnail_dir', type=str, default='/home/ARFF/Dataset_FTD/JPEGImages')
